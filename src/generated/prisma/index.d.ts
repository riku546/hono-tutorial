...
export namespace Prisma {
  ...
  */
  ...
  export type MemoOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"title" | "content" | "createdAt" | "updatedAt" | "userId", ExtArgs["result"]["memo"]>
  ...
  export interface MemoDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const memoWithTitleOnly = await prisma.memo.findMany({ select: { title: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Memos and only return the `title`
     * const memoWithTitleOnly = await prisma.memo.createManyAndReturn({
     *   select: { title: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Memos and only return the `title`
     * const memoWithTitleOnly = await prisma.memo.updateManyAndReturn({
     *   select: { title: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface MemoFieldRefs {
    ...
    readonly createdAt: FieldRef<"Memo", 'DateTime'>
    readonly updatedAt: FieldRef<"Memo", 'DateTime'>
    readonly userId: FieldRef<"Memo", 'String'>
  }
  ...
  export type MemoWhereInput = {
    ...
    createdAt?: DateTimeFilter<"Memo"> | Date | string
    updatedAt?: DateTimeFilter<"Memo"> | Date | string
    userId?: StringFilter<"Memo"> | string
  ...
  export type MemoWhereUniqueInput = Prisma.AtLeast<{
    userId_createdAt?: MemoUserIdCreatedAtCompoundUniqueInput
    AND?: MemoWhereInput | MemoWhereInput[]
    OR?: MemoWhereInput[]
    NOT?: MemoWhereInput | MemoWhereInput[]
    title?: StringFilter<"Memo"> | string
  ...
  export type MemoScalarWhereWithAggregatesInput = {
    ...
    createdAt?: DateTimeWithAggregatesFilter<"Memo"> | Date | string
    updatedAt?: DateTimeWithAggregatesFilter<"Memo"> | Date | string
    userId?: StringWithAggregatesFilter<"Memo"> | string
  }
  ...
  export type MemoUserIdCreatedAtCompoundUniqueInput = {
    userId: string
    createdAt: Date | string
  }
